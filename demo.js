...
const gui = new GUI()
gui.closed=false;
const slantfolder = gui.addFolder('Distance')
const parameters = {
  "4": true,
  "8": false,
  "12": false 
}
var d4 = slantfolder.add(parameters, '4').name('4').listen().onChange(function(){setChecked("4")});
var d8 = slantfolder.add(parameters, '8').name('8').listen().onChange(function(){setChecked("8")});
var d12 = slantfolder.add(parameters, '12').name('12').listen().onChange(function(){setChecked("12")});
slantfolder.closed=false;
